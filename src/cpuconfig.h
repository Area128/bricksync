...
#define CPUCONF_VENDOR_AMD
#define CPUCONF_IDENTIFIER "AMD Opteron(tm) Processor 6378                 "
#define CPUCONF_CLASS_BULLDOZER
#define CPUCONF_SOCKET_LOGICAL_CORES (16)
#define CPUCONF_SOCKET_PHYSICAL_CORES (16)
#define CPUCONF_SOCKET_COUNT (2)
#define CPUCONF_TOTAL_CORE_COUNT (32)
#define CPUCONF_SYSTEM_MEMORY (137420206080LL)
#define CPUCONF_WORD_SIZE (64)
#define CPUCONF_CACHE_LINE_SIZE (64)
#define CPUCONF_CACHE_L1CODE_SIZE (65536)
#define CPUCONF_CACHE_L1CODE_LINE (64)
#define CPUCONF_CACHE_L1CODE_ASSOCIATIVITY (2)
#define CPUCONF_CACHE_L1CODE_SHARED (2)
#define CPUCONF_CACHE_L1DATA_SIZE (16384)
#define CPUCONF_CACHE_L1DATA_LINE (64)
#define CPUCONF_CACHE_L1DATA_ASSOCIATIVITY (4)
#define CPUCONF_CACHE_L1DATA_SHARED (1)
#define CPUCONF_CACHE_L1_UNIFIED_FLAG (0)
#define CPUCONF_CACHE_L2_SIZE (2097152)
#define CPUCONF_CACHE_L2_LINE (64)
#define CPUCONF_CACHE_L2_ASSOCIATIVITY (16)
#define CPUCONF_CACHE_L2_SHARED (2)
#define CPUCONF_CACHE_L3_SIZE (6291456)
#define CPUCONF_CACHE_L3_LINE (64)
#define CPUCONF_CACHE_L3_ASSOCIATIVITY (48)
#define CPUCONF_CACHE_L3_SHARED (8)
...
#define CPUCONF_CAP_SSE4A
#define CPUCONF_CAP_AVX
#define CPUCONF_CAP_XOP
#define CPUCONF_CAP_FMA3
#define CPUCONF_CAP_FMA4
#define CPUCONF_CAP_MISALIGNSSE
#define CPUCONF_CAP_AES
#define CPUCONF_CAP_PCLMUL
#define CPUCONF_CAP_CMPXCHG16B
#define CPUCONF_CAP_LZCNT
#define CPUCONF_CAP_MOVBE
#define CPUCONF_CAP_RDTSCP
#define CPUCONF_CAP_CONSTANTTSC
#define CPUCONF_CAP_F16c
#define CPUCONF_CAP_TBM
